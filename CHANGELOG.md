...
- facet selection and search button added to browse pages for long lists of facet results
- ability to facet by a nested field, where another nested field equals a given value
